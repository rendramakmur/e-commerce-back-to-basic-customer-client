            ...
            <div class="card shadow mx-5">
              <div class="card-body">
                ...
                <div class="col-8 offset-2">
                  <label for="email" class="very-small-text">Full name</label>
                  <input class="form-control form-control-dm mb-3" id="email" type="text" placeholder="Full name">
                </div>
                ...
                <div class="d-flex justify-content-center my-4">
                  <a href="#" class="medium-btn shadow">Register</a>
                </div>
